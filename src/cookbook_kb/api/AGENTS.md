...
- `routers/` — `recipes.py` (search/detail/semantic), `intelligence.py` (`/ask`, meal-plan, shopping list, substitutions), `state.py` (favorites/pantry/ratings/…), `ingest.py` (URL + async PDF jobs).
